...
$search='<article class="search">
        <form action="/admin/'.$this->type->method.'/form" data-list="/admin/'.$this->type->method.'/list">
        <fieldset>
            <legend>검색</legend>
            <input type = "text" id = "name">
            <button type="button" id="search_btna" data-kind = '.$this->type->method."a".'><img src="/public/template/control/img/search.png" alt="검색"></button>
            <button type = "button" id = "listset" data-kind = '.$this->type->method."a".'>전체보기</button>
        </fieldset>
    </form>
</article>';
?>
