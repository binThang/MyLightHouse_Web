...
function prev(){
    console.log(array[5]);
    if(array[5] == 3){
        location.href = '/fun/list2/2';
    }
    else if(array[5] == 2){
        location.href = '/fun/list2/1';
    }
}
function next(){
    console.log(array[5]);
...
function viewnext(type){
    ...
    $.ajax({
        ...
        if(board_idx != 0 && board_idx != null){
            location.href = '/fun/view/'+board_idx;
        }
    });
